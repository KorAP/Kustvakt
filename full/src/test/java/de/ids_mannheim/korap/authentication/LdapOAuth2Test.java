...
@DisplayName("Ldap O Auth 2 Test")
class LdapOAuth2Test extends OAuth2TestBase {
    ...
    @AfterEach
    void resetAuthenticationMethod() {
        config.setOAuth2passwordAuthentication(AuthenticationMethod.TEST);
    }

    @Test
    @DisplayName("Test Request Token Password Unknown User")
    void testRequestTokenPasswordUnknownUser() throws KustvaktException {
    ...
    @Test
    @DisplayName("Test Map Email To Username")
    void testMapEmailToUsername() throws KustvaktException {
