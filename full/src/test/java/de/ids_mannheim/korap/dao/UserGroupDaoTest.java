...
@DisplayName("User Group Dao Test")
class UserGroupDaoTest {
    ...
    @Test
    @DisplayName("Create Delete New User Group")
    void createDeleteNewUserGroup() throws KustvaktException {
    ...
    @Test
    @DisplayName("Retrieve Group With Members")
    void retrieveGroupWithMembers() throws KustvaktException {
        // dory group
    ...
    @Test
    @DisplayName("Retrieve Group By User Id")
    void retrieveGroupByUserId() throws KustvaktException {
    ...
    @Test
    @DisplayName("Add VC To Group")
    void addVCToGroup() throws KustvaktException {
        // dory group
        int groupId = 2;
