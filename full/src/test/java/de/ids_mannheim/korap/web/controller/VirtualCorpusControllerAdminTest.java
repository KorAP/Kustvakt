 ...
 * @author margaretha
 */
@DisplayName("Virtual Corpus Controller Admin Test")
class VirtualCorpusControllerAdminTest extends VirtualCorpusTestBase {
    ...
    void testCreatePrivateVC() throws ProcessingException, KustvaktException {
    ...
    @Test
    @DisplayName("Test VC Sharing")
    void testVCSharing() throws ProcessingException, KustvaktException {
