...
@DisplayName("O Auth 2 Open Id Controller Test")
class OAuth2OpenIdControllerTest extends SpringJerseyTest {
    ...
    @Test
    @DisplayName("Test Request Authorization Code")
    void testRequestAuthorizationCode() throws ProcessingException, KustvaktException {
        Form form = new Form();
    ...
    @Test
    @DisplayName("Test Request Authorization Code Missing Client ID")
    void testRequestAuthorizationCodeMissingClientID() throws KustvaktException {
        Form form = new Form();
        form.param("scope", "openid");
        form.param("redirect_uri", redirectUri);
    ...
    @Test
    @DisplayName("Test Request Authorization Code Missing Response Type")
    void testRequestAuthorizationCodeMissingResponseType() throws KustvaktException {
        Form form = new Form();
        form.param("scope", "openid");
        form.param("redirect_uri", redirectUri);
     ...
     */
    @Test
    @DisplayName("Test Request Authorization Code Unsupported Implicit Flow")
    void testRequestAuthorizationCodeUnsupportedImplicitFlow() throws KustvaktException {
        Form form = new Form();
        form.param("scope", "openid");
        form.param("redirect_uri", redirectUri);
     ...
     */
    @Test
    @DisplayName("Test Request Authorization Code Unsupported Hybrid Flow")
    void testRequestAuthorizationCodeUnsupportedHybridFlow() throws KustvaktException {
        Form form = new Form();
        form.param("scope", "openid");
        form.param("redirect_uri", redirectUri);
    ...
    @Test
    @DisplayName("Test Request Access Token With Authorization Code")
    void testRequestAccessTokenWithAuthorizationCode() throws KustvaktException, ParseException, InvalidKeySpecException, NoSuchAlgorithmException, JOSEException {
    ...
    // no openid
    @Test
    @DisplayName("Test Request Access Token With Password")
    void testRequestAccessTokenWithPassword() throws KustvaktException, ParseException, InvalidKeySpecException, NoSuchAlgorithmException, JOSEException {
        // public client
    ...
    @Test
    @DisplayName("Test Public Key API")
    void testPublicKeyAPI() throws KustvaktException {
    ...
    @Test
    @DisplayName("Test Open ID Configuration")
    void testOpenIDConfiguration() throws KustvaktException {
