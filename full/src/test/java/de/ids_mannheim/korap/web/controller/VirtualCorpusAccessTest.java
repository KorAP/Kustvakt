...
@DisplayName("Virtual Corpus Access Test")
class VirtualCorpusAccessTest extends VirtualCorpusTestBase {

    private String testUser = "VirtualCorpusAccessTest";

    @Test
    @DisplayName("Testlist Access By Non VCA Admin")
    void testlistAccessByNonVCAAdmin() throws KustvaktException {
    ...
    // }
    @Test
    @DisplayName("Testlist Access By Group")
    void testlistAccessByGroup() throws KustvaktException {
    ...
    @Test
    @DisplayName("Test Delete Shared VC")
    void testDeleteSharedVC() throws KustvaktException {
    ...
    @Test
    @DisplayName("Test Create Delete Access")
    void testCreateDeleteAccess() throws ProcessingException, KustvaktException {
    ...
    @Test
    @DisplayName("Test Delete Non Existing Access")
    void testDeleteNonExistingAccess() throws ProcessingException, KustvaktException {
