 ...
 * @author margaretha
 */
@DisplayName("User Group Controller Test")
class UserGroupControllerTest extends SpringJerseyTest {
    ...
    @Test
    @DisplayName("Test List Dory Groups")
    void testListDoryGroups() throws KustvaktException {
    ...
    @Test
    @DisplayName("Test List Nemo Groups")
    void testListNemoGroups() throws KustvaktException {
    ...
    // marlin has 2 groups
    @Test
    @DisplayName("Test List Marlin Groups")
    void testListMarlinGroups() throws KustvaktException {
    ...
    @Test
    @DisplayName("Test List Group Guest")
    void testListGroupGuest() throws KustvaktException {
    ...
    @Test
    @DisplayName("Test Create Group Empty Description")
    void testCreateGroupEmptyDescription() throws ProcessingException, KustvaktException {
    ...
    @Test
    @DisplayName("Test Create Group Missing Description")
    void testCreateGroupMissingDescription() throws ProcessingException, KustvaktException {
    ...
    @Test
    @DisplayName("Test Create Group Invalid Name")
    void testCreateGroupInvalidName() throws ProcessingException, KustvaktException {
    ...
    @Test
    @DisplayName("Test Create Group Name Too Short")
    void testCreateGroupNameTooShort() throws ProcessingException, KustvaktException {
        String groupName = "a";
        Response response = testCreateGroupWithoutDescription(groupName);
        assertEquals(Status.BAD_REQUEST.getStatusCode(), response.getStatus());
        JsonNode node = JsonUtils.readTree(response.readEntity(String.class));
    ...
    void testUserGroup() throws ProcessingException, KustvaktException {
    ...
    void testDeleteDeletedMember() throws ProcessingException, KustvaktException {
        Response response = target().path(API_VERSION).path("group").path("@dory-group").path("~pearl").request().header(Attributes.AUTHORIZATION, HttpAuthorizationHandler.createBasicAuthorizationHeaderValue("dory", "pass")).header(HttpHeaders.X_FORWARDED_FOR, "149.27.0.32").delete();
        String entity = response.readEntity(String.class);
        // System.out.println(entity);
        JsonNode node = JsonUtils.readTree(entity);
    ...
    @Test
    @DisplayName("Test Delete Group Unauthorized")
    void testDeleteGroupUnauthorized() throws ProcessingException, KustvaktException {
    ...
    @Test
    @DisplayName("Test Delete Deleted Group")
    void testDeleteDeletedGroup() throws ProcessingException, KustvaktException {
    ...
    @Test
    @DisplayName("Test Delete Group Owner")
    void testDeleteGroupOwner() throws ProcessingException, KustvaktException {
    ...
    @Test
    @DisplayName("Test Invite Deleted Member 2")
    void testInviteDeletedMember2() throws ProcessingException, KustvaktException {
    ...
    @Test
    @DisplayName("Test Invite Pending Member")
    void testInvitePendingMember() throws ProcessingException, KustvaktException {
    ...
    @Test
    @DisplayName("Test Invite Active Member")
    void testInviteActiveMember() throws ProcessingException, KustvaktException {
    ...
    @Test
    @DisplayName("Test Invite Member To Deleted Group")
    void testInviteMemberToDeletedGroup() throws ProcessingException, KustvaktException {
        Form form = new Form();
        form.param("members", "nemo");
    ...
    @Test
    @DisplayName("Test Subscribe Pending Member")
    void testSubscribePendingMember() throws KustvaktException {
    ...
    @Test
    @DisplayName("Test Subscribe Deleted Member")
    void testSubscribeDeletedMember() throws KustvaktException {
    ...
    @Test
    @DisplayName("Test Subscribe Missing Group Name")
    void testSubscribeMissingGroupName() throws KustvaktException {
    ...
    @Test
    @DisplayName("Test Subscribe Non Existent Member")
    void testSubscribeNonExistentMember() throws KustvaktException {
    ...
    @Test
    @DisplayName("Test Subscribe To Non Existent Group")
    void testSubscribeToNonExistentGroup() throws KustvaktException {
    ...
    @Test
    @DisplayName("Test Unsubscribe Deleted Member")
    void testUnsubscribeDeletedMember() throws ProcessingException, KustvaktException {
    ...
    @Test
    @DisplayName("Test Unsubscribe Pending Member")
    void testUnsubscribePendingMember() throws ProcessingException, KustvaktException {
        JsonNode node = retrieveUserGroups("marlin");
        assertEquals(2, node.size());
    ...
    @Test
    @DisplayName("Test Unsubscribe Missing Group Name")
    void testUnsubscribeMissingGroupName() throws KustvaktException {
    ...
    @Test
    @DisplayName("Test Unsubscribe Non Existent Member")
    void testUnsubscribeNonExistentMember() throws KustvaktException {
    ...
    @Test
    @DisplayName("Test Unsubscribe To Non Existent Group")
    void testUnsubscribeToNonExistentGroup() throws KustvaktException {
    ...
    void testAddSameMemberRole() throws ProcessingException, KustvaktException {
        Form form = new Form();
    ...
    @Test
    @DisplayName("Test Delete Add Member Role")
    void testDeleteAddMemberRole() throws ProcessingException, KustvaktException {
        Form form = new Form();
        form.param("memberUsername", "dory");
        form.param("roleId", "1");
    ...
    @Test
    @DisplayName("Test Edit Member Role Empty")
    void testEditMemberRoleEmpty() throws ProcessingException, KustvaktException {
        Form form = new Form();
        form.param("memberUsername", "dory");
