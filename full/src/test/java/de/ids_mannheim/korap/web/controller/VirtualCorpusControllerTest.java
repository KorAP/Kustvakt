...
class VirtualCorpusControllerTest extends VirtualCorpusTestBase {
    ...
    @Test
    @DisplayName("Test Create System VC _ unauthorized")
    ...
    @Test
    @DisplayName("Test Create VC _ invalid Name")
    ...
    @Test
    @DisplayName("Test Create VC _ name Too Short")
    ...
    @Test
    @DisplayName("Test Create VC _ unauthorized")
    ...
    @Test
    @DisplayName("Test Create VC _ without Corpus Query")
    ...
    @Test
    @DisplayName("Test Create VC _ without Entity")
    ...
    @Test
    @DisplayName("Test Create VC _ without Type")
    ...
    @Test
    @DisplayName("Test Create VC _ with Wrong Type")
    ...
    @Test
    @DisplayName("Test Delete VC _ unauthorized")
    ...
    @Test
    @DisplayName("Test Edit VC _ not Owner")
