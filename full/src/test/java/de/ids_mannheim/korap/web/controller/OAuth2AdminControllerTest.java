...
@DisplayName("OAuth2 Admin Controller Test")
class OAuth2AdminControllerTest extends OAuth2TestBase {
    ...
    @Test
    @DisplayName("Test Clean Expired Tokens Using Admin Token")
    void testCleanExpiredTokensUsingAdminToken() {
        int refreshTokensBefore = refreshDao.retrieveInvalidRefreshTokens().size();
    ...
    @Test
    @DisplayName("Test Clean Revoked Tokens")
    void testCleanRevokedTokens() throws KustvaktException {
        int accessTokensBefore = accessDao.retrieveInvalidAccessTokens().size();
    ...
    @Test
    @DisplayName("Test Update Client Privilege")
    void testUpdateClientPrivilege() throws KustvaktException {
        // register a client
