 ...
 * @author margaretha
 */
@DisplayName("User Setting Controller Test")
class UserSettingControllerTest extends SpringJerseyTest {
    ...
    @Test
    @DisplayName("Test Create Setting With Json")
    void testCreateSettingWithJson() throws KustvaktException {
    ...
    @Test
    @DisplayName("Test Create Setting With Map")
    void testCreateSettingWithMap() throws KustvaktException {
    ...
    @Test
    @DisplayName("Testput Request Invalid Key")
    void testputRequestInvalidKey() throws KustvaktException {
        Map<String, Object> map = new HashMap<>();
    ...
    @Test
    @DisplayName("Test Put Different Username")
    void testPutDifferentUsername() throws KustvaktException {
        String json = "{\"pos-foundry\":\"opennlp\",\"metadata\":\"author title " + "textSigle availability\",\"resultPerPage\":25}";
    ...
    @Test
    @DisplayName("Test Get Different Username")
    void testGetDifferentUsername() throws KustvaktException {
    ...
    @Test
    @DisplayName("Test Get Setting Not Exist")
    void testGetSettingNotExist() throws KustvaktException {
    ...
    @Test
    @DisplayName("Test Delete Setting Not Exist")
    void testDeleteSettingNotExist() throws KustvaktException {
        String username = "tralala";
    ...
    @Test
    @DisplayName("Test Delete Key Different Username")
    void testDeleteKeyDifferentUsername() throws KustvaktException {
