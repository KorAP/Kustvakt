...
@DisplayName("O Auth 2 R Client Test")
class OAuth2RClientTest extends OAuth2TestBase {
    ...
    @Test
    @DisplayName("Test R Client With Localhost")
    void testRClientWithLocalhost() throws ProcessingException, KustvaktException, IOException {
        // Register client
