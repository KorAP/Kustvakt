...
@DisplayName("Icc Test")
class ICCTest extends SpringJerseyTest {
    ...
    @Test
    @DisplayName("Search Without Login")
    void searchWithoutLogin() throws KustvaktException {
    ...
    @Test
    @DisplayName("Search With Login")
    void searchWithLogin() throws KustvaktException {
    ...
    @Test
    @DisplayName("Match Info Without Login")
    void matchInfoWithoutLogin() throws KustvaktException {
    ...
    @Test
    @DisplayName("Match Info With Login")
    void matchInfoWithLogin() throws KustvaktException {
