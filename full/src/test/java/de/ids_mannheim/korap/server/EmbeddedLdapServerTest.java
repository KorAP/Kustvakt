...
public class EmbeddedLdapServerTest {
    ...
    public void embeddedServerStartsAutomaticallyAndUsersCanLogin() throws LDAPException {
        ...
        assertEquals(LDAP_AUTH_RUNKNOWN, LdapAuth3.login("yuser", pw, "src/main/resources/ldap.properties"));
    }
    ...
    public void unauthorizedUsersAreNotAllowed() throws LDAPException {
        ...
        assertEquals(LDAP_AUTH_RUNKNOWN, LdapAuth3.login("user1", pw, "src/main/resources/ldap.properties"));
    }
}