...
// }
@DisplayName("Rewrite Handler Test")
class RewriteHandlerTest extends SpringJerseyTest {

    @Autowired
    private KustvaktConfiguration config;

    @Test
    @DisplayName("Test Rewrite Task Add")
    void testRewriteTaskAdd() {
        RewriteHandler handler = new RewriteHandler(config);
        assertTrue(handler.add(FoundryInject.class));
    ...
    @Test
    @DisplayName("Test Rewrite Config Throws Exception")
    void testRewriteConfigThrowsException() {
